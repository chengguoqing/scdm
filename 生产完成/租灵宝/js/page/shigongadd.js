...
var km = new Vue({
	...
	methods: {
		...
		tytew_sd: function tytew_sd(dta) {
			document.activeElement.blur();
			var sd_Sd = this;
		...
		feni_sdfx_b: function feni_sdfx_b() {
			//工程类别
			document.activeElement.blur();
			var sd_sdd = this;
	...
	created: function created() {
		...
		mui.plusReady(function () {
			...
			m_ajax(projectlog, function (data) {
				//获取分类信息
				var sd_sds = [];
...
//# sourceMappingURL=shigongadd.js.map
