...
$(function () {
    ...
    $("#tyiyte_sfgx_b").on("blur", function () {
        //店铺全称
        var df_dsd = $(this).val();
        if (!df_dsd) {
            return;
    ...
    $(".dsfs_df_sfgx").on("click", function () {
        //弹出层叉叉
        $(".sd_sd_sfg_xdsgxc").removeClass("show");
    }
    ...
    /*营业时间*/
        ...
        var df_df = $(".sd_dsf_dsf_df.aa").val() + "~" + $(".sd_dsf_dsf_df.ab").val();
