...
$("body").on("tap",".close_erer",function(){
    $(".dsf_bg_sert").remove()
    $(".mui-inner-wrap").removeClass("act")
    localStorage.xiazai="xiazai"
    
})
if(localStorage.xiazai){//判断是否点击了下载的x按钮
      $(".dsf_bg_sert").remove()
      $(".mui-inner-wrap").removeClass("act")
}
try {
