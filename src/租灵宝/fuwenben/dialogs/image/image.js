        ...
        pushData: function (list) {
            ...
            for (i = 0; i < list.length; i++) {
                if(list[i] && list[i].url) {
                    ...
                    /*删除图片*/
                    item.appendChild($("<span class='delbtn' id='" + list[i].id + "' uid='"+ list[i].user_id+"'>✖</span>").click(function (){
                        var del = $(this);
                        try {
                            ...
                            $.ajax({
                                url:editor.getOpt("serverUrl") + "ajaximg.deleteimage&webface_access_token=buddhaaccesstoken",
                                type: 'GET',
                                dataType: 'json',
                                data:{webface_access_token:'buddhaaccesstoken',
                                    imgid:del.attr("id"),
                                    uid:del.attr("uid")
                                }
                            })
